    ...
    <main className="min-h-[70vh] flex items-center justify-center px-6 py-12">
      <div className="w-full max-w-3xl rounded-3xl border border-secondary/30 bg-background/95 p-10 shadow-lg">
        <div className="space-y-4 text-center">
          <p className="text-sm uppercase tracking-[0.2em] text-primary">Post Management</p>
          <h1 className="text-3xl font-semibold">Post history is unavailable</h1>
          <p className="text-muted-foreground">
            The post management section has been hidden from the portal UI.
          </p>
