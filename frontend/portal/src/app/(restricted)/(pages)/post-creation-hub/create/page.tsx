    ...
    <main className="min-h-[70vh] flex items-center justify-center px-6 py-12">
      <div className="w-full max-w-3xl rounded-3xl border border-secondary/30 bg-background/95 p-10 shadow-lg">
        <div className="space-y-4 text-center">
          <p className="text-sm uppercase tracking-[0.2em] text-primary">Post Creation Hub</p>
          <h1 className="text-3xl font-semibold">This feature has been hidden</h1>
          <p className="text-muted-foreground">
            AI-powered Reddit post creation is no longer available in the portal UI.
          </p>
